...
python analyze_SED.py --p_exp=3 --f_omega=1.00 --eps_E=0.1 --eps_B=0.1 --Te_csm=1e4 --epochs 50 100 500 1000 5000 10000 --model_dir './evolve_shock/shell_evolution_rhoISM_10e-24_cgs/' --evolve_shock_dir './evolve_shock/shell_evolution_rhoISM_10e-24_cgs/' --data_dir './evolve_spectrum_epsB_1e-1/shell_evolution_rhoISM_10e-24_cgs/' --dNdgamma_dir './evolve_spectrum_epsB_1e-1/shell_evolution_rhoISM_10e-24_cgs/'
