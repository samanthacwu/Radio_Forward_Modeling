...
path_to_data = './evolve_spectrum_adiabatic/shell_evolution_Mflare_1E-02_deltat_1.00yr/shock_data.npz'
path_to_data_old = './evolve_spectrum/shell_evolution_Mflare_1E-02_deltat_1.00yr/shock_data.npz'
...
# ax[2].set_ylabel('density ahead of shock (g/cm^3)')
