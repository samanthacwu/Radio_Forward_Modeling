...
# python spectrum_evolution.py './evolve_spectrum_epsB_1e-1/shell_evolution_deltat_1yr/' './evolve_spectrum_epsB_1e-1/shell_evolution_deltat_1yr/' --p_exp=3 --eps_B=0.1 --eps_E=0.1 --f_omega=1.00 --max_step=100000 --print_int=10000 --dt_sc=1e-3 --t0=0.12 --tf=111
