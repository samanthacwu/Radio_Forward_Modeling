...
python spectrum_evolution.py './evolve_spectrum_epsB_1e-2/shell_evolution_deltat_1yr/' './evolve_spectrum_epsB_1e-2/shell_evolution_deltat_1yr/' --p_exp=2.1 --eps_B=0.01 --eps_E=0.001 --f_omega=1.00 --max_step=20000 --print_int=1000 --dt_sc=1e-4 --t0=0.15 --tf=130
